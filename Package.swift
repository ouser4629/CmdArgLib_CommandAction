...
// --- Remote and local use of cmd-arg-lib
...
let package = Package(
    ...
    dependencies: [
        // Remote
         .package(url: "https://github.com/ouser4629/cmd-arg-lib.git", from: "0.4.7")
        // Local
